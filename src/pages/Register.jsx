...
export default function Register() {
  ...
  return (
    <>
      <div className="h-[95vh] flex justify-center items-center bg-gray-200 overflow-hidden">
        <div className="shadow-2xl z-0 px-5 pt-5 rounded-xl sm:min-w-96 bg-white pb-10 shadow-teal-400 m-4 hover:scale-105 hover:shadow-blue-400">
          <h1 className="text-center text-3xl italic font-semibold pb-5 ">
            Register
          </h1>
          <form method="post" action={"/"} onSubmit={submithandle}>
            <div className="mb-2">
              <label htmlFor="username" className="text-xl block mb-1 ">
                Username
              </label>
              <input
                type="text"
